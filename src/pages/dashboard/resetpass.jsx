...
const ProtectedPage = ({ user }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    const contract = new ethers.Contract(contractAddress, abi, signer);
            try {
                const tx = await contract.resetPassword(user.email, formData.oldpassword, formData.password);
                ...
                if (receipt.status === 1) {
                  ...
                  setButton("Password Changed successfully ");
                } else {
                ...
                setButtonDisabled(false);
                setButton("Password cannot be changed");
              }
